    ...
    <div>
      ...
      >
        <span slot-scope="{ node,data}">
          ...
          <svg-icon v-if="data.icon=='质检中心'" icon-class="质检中心" style="width:20px;height:20px;"/>
          <svg-icon v-else-if="data.icon=='泵单位'" icon-class="水泵企业" style="width:20px;height:20px;"/>
          <svg-icon v-else-if="data.icon=='实验室'" icon-class="实验室" style="width:20px;height:20px;"/>
