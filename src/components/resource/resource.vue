<template>
  <div class="resource1" style="border-left:38px solid #1579bf;padding-left:10px;">
    <div>
      <el-input v-model="search" placeholder="请输入集中器地址搜索" style="width:150px"/>
      <el-button type="primary" size="mini" @click="searchvalue">搜索</el-button>
      ...
      >
        <span slot-scope="{ node,data}">
          ...
          <span v-else-if="data.icon=='电表'" style="padding-left: 4px;">(电能表){{ node.label+'[pn:'+data.pn+']' }}</span>
