        ...
        <el-row>
          <el-col :span="12"><div class="grid-content bg-purple">
              <el-form-item label="实验室名称" prop="name">
                <el-input v-model="laboratoryForm.name"></el-input>
              </el-form-item>
              <el-form-item label="实验室级别" prop="level">
               ...
               <el-form-item label="实验室地址" >
                <el-input v-model="laboratoryForm.addr"></el-input>
              </el-form-item>
              <el-form-item label="建设起止日期" >
                <el-col :span="11">
                  <el-form-item prop="buildstarttime" style="margin-bottom:0">
                    <el-date-picker type="date" placeholder="选择日期" v-model="laboratoryForm.buildstarttime" style="width: 100%;"></el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col class="line" :span="2">-</el-col>
                <el-col :span="11">
                  <el-form-item prop="buildendtime" style="margin-bottom:0">
                    <el-date-picker type="date" placeholder="选择日期" v-model="laboratoryForm.buildendtime" style="width: 100%;"></el-date-picker>
                  </el-form-item>
                </el-col>
              </el-form-item>
               <el-form-item label="实验室负责人" prop="leadingname">
                <el-input v-model="laboratoryForm.leadingname"></el-input>
              </el-form-item>
                ...
                <i v-else class="el-icon-plus avatar-uploader-icon" ></i>
                  ...
                  <el-col :span="12"><div class="grid-content bg-purple-light">
                      <el-form-item label="主管单位" prop="unit">
                        <el-input v-model="laboratoryForm.unit"></el-input>
                      </el-form-item>
                      ...
                      <el-form-item label="负责人电话" prop="leadingphone">
                        <el-input v-model="laboratoryForm.leadingphone"></el-input>
                      </el-form-item>
                      <el-form-item label="联系人电话" prop="linkphone">
                        <el-input v-model="laboratoryForm.linkphone"></el-input>
                      </el-form-item>
                  </div></el-col>
        </el-row>
          <p
            ...
            <el-col :span="12">
              <div class="grid-content bg-purple-light">
                <el-form-item label="证书编号" prop="credentialsname">
                  <el-input v-model="laboratoryForm.credentialsname"></el-input>
                </el-form-item>
                <el-form-item  required label="签发日期">
                <el-col :span="11">
                  <el-form-item prop="dateOfIssue" style="margin-bottom:0" >
                    <el-date-picker type="date" placeholder="选择日期" v-model="laboratoryForm.dateOfIssue" style="width: 100%;" value-format="timestamp"></el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="11">
                  <el-form-item prop="termOfValidity" style="margin-bottom:0" label="有效期至">
                    <el-date-picker placeholder="选择有效期" v-model="laboratoryForm.termOfValidity" style="width: 100%;" type="date" value-format="timestamp"></el-date-picker>
                  </el-form-item>
                </el-col>
              </el-form-item>
