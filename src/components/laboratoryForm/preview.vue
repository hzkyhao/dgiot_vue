<template>
  <div class="laboratory">
        ...
        <el-row>
          <el-col :span="12"><div class="grid-content bg-purple">
            <el-form-item label="实验室名称" prop="name">
              <el-input v-model="laboratoryForm.name" readonly/>
            </el-form-item>
            ...
            <el-form-item label="实验室地址" prop="addr">
              <el-input v-model="laboratoryForm.addr" readonly/>
            </el-form-item>
            <el-form-item label="建设起止日期" required>
              <el-col :span="11">
                <el-form-item prop="buildstarttime" style="margin-bottom:0">
                  <el-date-picker v-model="laboratoryForm.buildstarttime" type="date" placeholder="选择日期" style="width: 100%;" readonly/>
                </el-form-item>
              </el-col>
              <el-col :span="2" class="line">-</el-col>
              <el-col :span="11">
                <el-form-item prop="buildendtime" style="margin-bottom:0">
                  <el-date-picker v-model="laboratoryForm.buildendtime" type="date" placeholder="选择日期" style="width: 100%;" readonly/>
                </el-form-item>
              </el-col>
            </el-form-item>
            <el-form-item label="实验室负责人" prop="leadingname">
              <el-input v-model="laboratoryForm.leadingname" readonly/>
            </el-form-item>
            <el-form-item label="实验室联系人" prop="linkname">
              <el-input v-model="laboratoryForm.linkname" readonly/>
            </el-form-item>
          ...
          <el-col :span="12"><div class="grid-content bg-purple-light">
            <el-form-item label="主管单位" prop="unit">
              <el-input v-model="laboratoryForm.unit" readonly/>
            </el-form-item>
            ...
            <el-form-item label="负责人电话" prop="leadingphone">
              <el-input v-model="laboratoryForm.leadingphone" readonly/>
            </el-form-item>
            <el-form-item label="联系人电话" prop="linkphone">
              <el-input v-model="laboratoryForm.linkphone" readonly/>
            </el-form-item>
          </div></el-col>
        </el-row>
        <p
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple-light">
              <el-form-item label="证书编号" prop="credentialsname">
                <el-input v-model="laboratoryForm.credentialsname" readonly/>
              </el-form-item>
              <el-form-item required label="签发日期">
                <el-col :span="11">
                  <el-form-item prop="dateOfIssue" style="margin-bottom:0" >
                    <el-date-picker v-model="laboratoryForm.dateOfIssue" type="date" placeholder="选择日期" style="width: 100%;" value-format="timestamp" readonly/>
                  </el-form-item>
                </el-col>
                <el-col :span="11">
                  <el-form-item prop="termOfValidity" style="margin-bottom:0" label="有效期至">
                    <el-date-picker v-model="laboratoryForm.termOfValidity" placeholder="选择有效期" style="width: 100%;" type="date" value-format="timestamp" readonly/>
                  </el-form-item>
                </el-col>
              </el-form-item>
              <el-form-item prop="updatedDate" label="更新时间">
                <el-date-picker v-model="laboratoryForm.updatedDate" placeholder="选择时间" type="date" value-format="timestamp" readonly/>
              </el-form-item>
    ...
    <el-row v-for="(item,index) in otherform" :key="index" :value="item">
      <el-form ref="addotherform" :model="item" label-width="120px" class="demo-addotherform" >
        <p
