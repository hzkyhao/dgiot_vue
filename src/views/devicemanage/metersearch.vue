<template>
  <div id="metersearch" style="display:flex;">
    ...
    <div style="width:calc(100% - 360px);">
      <el-form :inline="true" :model="formInline" class="demo-form-inline" size="small">
        <el-form-item label="用户编号">
          <el-input v-model="formInline.userId" placeholder="请输入用户编号" @change="handleUserChange"/>
        </el-form-item>
        <el-form-item label="用户名称">
          <el-input v-model="formInline.user" placeholder="请输入用户名称"/>
        </el-form-item>
        <el-form-item label="电能表地址">
          <el-input v-model="formInline.electricityId" placeholder="请输入电能表地址"/>
        </el-form-item>
        <el-form-item label="集中器地址">
          <el-input v-model="formInline.cost" placeholder="请输入集中器地址"/>
        </el-form-item>
        <el-form-item label="用户地址">
          <el-input v-model="formInline.yhdz" placeholder="请输入地址"/>
        </el-form-item>
        <div>
          <el-form-item>
      ...
      <div id="table">
        ...
        <el-dialog :visible.sync="dialogFormVisible" title="修改信息">
          <el-form :model="mod_form">
            ...
            <el-form-item :label-width="formLabelWidth" label="供电单位">
              <el-input v-model="mod_form.gddw" :disabled="true" autocomplete="off"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="用户编号">
              <el-input v-model="mod_form.yhabh" :disabled="true" autocomplete="off"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="用户名称">
              <el-input v-model="mod_form.yhmc" autocomplete="off"/>
            </el-form-item>
            ...
            <el-form-item :label-width="formLabelWidth" label="台区名称">
              <el-input v-model="mod_form.tq" autocomplete="off"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="集中器地址">
              <el-input v-model="mod_form.vcaddr" :disabled="true" autocomplete="off"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="电能表地址">
              <el-input v-model="mod_form.addr" :disabled="true" autocomplete="off"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="PN值">
              <el-input v-model="mod_form.pn" autocomplete="off"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="CT倍率" >
              <el-input v-model.number="mod_form.ct" :min="1" autocomplete="off" placeholder="请输入ct值"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="PT倍率" >
              <el-input v-model.number="mod_form.pt" :min="1" autocomplete="off" placeholder="请输入pt值"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="抄表类型">
            ...
            <el-form-item :label-width="formLabelWidth" label="采集器编号">
              <el-input v-model="mod_form.deveui" autocomplete="off" placeholder="请输入采集器编号"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="应用编号">
              <el-input v-model="mod_form.appeui" autocomplete="off" placeholder="请输入应用编号"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="用户地址">
              <el-cascader
                :options="options"
            ...
            >
              <el-form-item :label-width="formLabelWidth" label="资产编号">
                <el-input v-model="mod_form.zcbh" autocomplete="off" placeholder="请输入资产标号编号"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="出厂编号">
                <el-input v-model="mod_form.ccbh" autocomplete="off" placeholder="请输入出厂编号"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="远程控制密码">
                <el-input
              ...
              <el-form-item :label-width="formLabelWidth" label="注册应用号">
                <el-input
              ...
              <el-form-item :label-width="formLabelWidth" label="计量点编号">
                <el-input v-model="mod_form.jldbh" autocomplete="off" placeholder="请输入计量点编号"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="投运时间">
                <el-date-picker v-model="mod_form.tysj" type="date" placeholder="选择日期"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="上次检验日期">
                <el-date-picker v-model="mod_form.scjyrq" type="date" placeholder="选择日期"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="到货批次号">
                <el-input v-model="mod_form.dhpc" autocomplete="off" placeholder="请输入到货批次号"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="综合倍率">
                <el-input v-model="mod_form.zhbl" autocomplete="off" placeholder="请输入综合倍率"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="抄表区段">
                <el-input v-model="mod_form.cbqd" autocomplete="off" placeholder="请输入抄表区段"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="线路">
                <el-input v-model="mod_form.xl" autocomplete="off" placeholder="请输入线路"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="厂站">
                <el-input v-model="mod_form.cz" autocomplete="off" placeholder="请输入厂站"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="额定电压">
                <el-input v-model="mod_form.eddy" autocomplete="off" placeholder="请输入额定电压"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="标定电流">
                <el-input v-model="mod_form.bddl" autocomplete="off" placeholder="请输入标定电流"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="准确率">
                <el-input v-model="mod_form.zqd" autocomplete="off" placeholder="请输入准确率"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="生产厂家">
                <el-input v-model="mod_form.sccj" autocomplete="off" placeholder="请输入生产厂家"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="主副表标志">
                <el-input v-model="mod_form.zfbbz" autocomplete="off" placeholder="请输入主副表标志"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="计量点位置">
                <el-input v-model="mod_form.jldwz" autocomplete="off" placeholder="请输入计量点位置"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="计量点地址">
                <el-input v-model="mod_form.jlddz" autocomplete="off" placeholder="请输入计量点地址"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="通信规约">
                <el-input v-model="mod_form.txgw" autocomplete="off" placeholder="请输入通信规约"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="逻辑地址">
                <el-input v-model="mod_form.ljdz" autocomplete="off" placeholder="请输入逻辑地址"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="波特率">
                <el-input v-model="mod_form.btl" autocomplete="off" placeholder="请输入波特率"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="计量表箱(柜)">
                <el-input v-model="mod_form.jlbx" autocomplete="off" placeholder="请输入计量表箱(柜)"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="箱(柜)位置号">
                <el-input v-model="mod_form.xgwzh" autocomplete="off" placeholder="请输入箱(柜)位置号"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="计量装置分类">
              ...
              <el-form-item :label-width="formLabelWidth" label="通信方式">
              ...
              <el-form-item :label-width="formLabelWidth" label="计量方式">
              ...
              <el-form-item :label-width="formLabelWidth" label="设备类别">
        ...
        <el-dialog :visible.sync="dialogFormVisibleAdd" title="新增">
          <el-form ref="add_form" :model="add_form" :rules="add_form_rules">
            <!-- 抄表档案 -->
            <el-divider content-position="left">抄表档案</el-divider>
            <el-form-item :label-width="formLabelWidth" label="供电单位" prop="gddw">
              <el-input v-model="add_form.gddw" autocomplete="off" readonly/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="用户编号">
              <el-input v-model="add_form.yhabh" autocomplete="off" placeholder="请输入用户编号"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="用户名称">
              <el-input v-model="add_form.yhmc" autocomplete="off" placeholder="请输入用户名称"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="用户类别">
            ...
            <el-form-item :label-width="formLabelWidth" label="台区名称" prop="tq">
              <el-input v-model="add_form.tq" autocomplete="off" placeholder="请输入台区名称"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="集中器地址" prop="vcaddr">
              <el-input
            ...
            <el-form-item :label-width="formLabelWidth" label="电能表地址" prop="addr">
              <el-input
            ...
            <el-form-item :label-width="formLabelWidth" label="PN值" prop="pn">
              <el-input v-model.number="add_form.pn" autocomplete="off" placeholder="请输入PN值"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="CT倍率" prop="ct">
              <el-input v-model.number="add_form.ct" :min="1" autocomplete="off" placeholder="请输入ct值"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="PT倍率" prop="pt">
              <el-input v-model.number="add_form.pt" :min="1" autocomplete="off" placeholder="请输入ct值"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="抄表类型">
            ...
            <el-form-item :label-width="formLabelWidth" :status-icon="true" label="采集器编号" prop="deveui" >
              <el-input v-model="add_form.deveui" autocomplete="off" placeholder="请输入采集器编号"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="应用编号">
              <el-input v-model="add_form.appeui" autocomplete="off" placeholder="请输入应用编号"/>
            </el-form-item>
            <el-form-item :label-width="formLabelWidth" label="用户地址">
              <el-cascader
                :options="options"
            ...
            >
              <el-form-item :label-width="formLabelWidth" label="资产编号">
                <el-input v-model="add_form.zcbh" autocomplete="off" placeholder="请输入资产标号编号"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="出厂编号">
                <el-input v-model="add_form.ccbh" autocomplete="off" placeholder="请输入出厂编号"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="远程控制密码">
                <el-input
              ...
              <el-form-item :label-width="formLabelWidth" label="计量点编号">
                <el-input v-model="add_form.jldbh" autocomplete="off" placeholder="请输入计量点编号"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="投运时间">
                <el-date-picker v-model="add_form.tysj" type="date" placeholder="选择日期"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="上次检验日期">
                <el-date-picker v-model="add_form.scjyrq" type="date" placeholder="选择日期"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="到货批次号">
                <el-input v-model="add_form.dhpc" autocomplete="off" placeholder="请输入到货批次号"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="综合倍率">
                <el-input v-model="add_form.zhbl" autocomplete="off" placeholder="请输入综合倍率"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="抄表区段">
                <el-input v-model="add_form.cbqd" autocomplete="off" placeholder="请输入抄表区段"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="线路">
                <el-input v-model="add_form.xl" autocomplete="off" placeholder="请输入线路"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="厂站">
                <el-input v-model="add_form.cz" autocomplete="off" placeholder="请输入厂站"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="额定电压">
                <el-input v-model="add_form.eddy" autocomplete="off" placeholder="请输入额定电压"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="标定电流">
                <el-input v-model="add_form.bddl" autocomplete="off" placeholder="请输入标定电流"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="准确率">
                <el-input v-model="add_form.zqd" autocomplete="off" placeholder="请输入准确率"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="生产厂家">
                <el-input v-model="add_form.sccj" autocomplete="off" placeholder="请输入生产厂家"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="主副表标志">
                <el-input v-model="add_form.zfbbz" autocomplete="off" placeholder="请输入主副表标志"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="计量点位置">
                <el-input v-model="add_form.jldwz" autocomplete="off" placeholder="请输入计量点位置"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="计量点地址">
                <el-input v-model="add_form.jlddz" autocomplete="off" placeholder="请输入计量点地址"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="通信规约">
                <el-input v-model="add_form.txgw" autocomplete="off" placeholder="请输入通信规约"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="逻辑地址">
                <el-input v-model="add_form.ljdz" autocomplete="off" placeholder="请输入逻辑地址"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="波特率">
                <el-input v-model="add_form.btl" autocomplete="off" placeholder="请输入波特率"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="计量表箱(柜)">
                <el-input v-model="add_form.jlbx" autocomplete="off" placeholder="请输入计量表箱(柜)"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="箱(柜)位置号">
                <el-input v-model="add_form.xgwzh" autocomplete="off" placeholder="请输入箱(柜)位置号"/>
              </el-form-item>
              <el-form-item :label-width="formLabelWidth" label="计量装置分类">
      ...
      <div class="block">
        ...
        <el-tooltip content="刷新" placement="top">
          <span class="iconfont iconicon-refresh" @click="reload"/>
        </el-tooltip>
        <el-tooltip content="导出当前表格" placement="top">
          <span class="iconfont iconxls der" @click="now_derive"/>
        </el-tooltip>
        <el-tooltip content="分页导出表格" placement="top">
          <span class="iconfont iconfile-xls ders" @click="show_table4"/>
        </el-tooltip>

        <el-dialog :visible.sync="centerDialogVisible" title="提示" width="15%" center>
          <div>
            <p>导出页从</p>
          ...
          <span slot="footer" class="dialog-footer">
            <el-button type="primary" plain @click="page_derive">导出</el-button>
    ...
    <!--新增框-->
    <el-dialog :visible.sync="addmeter" title="新增户表" width="50%">
      <el-form
        ref="ruleForm"
        :model="ruleForm"
        :rules="rules"
      ...
      <span slot="footer" class="dialog-footer">
        <el-button style="float:left" @click="addmeter = false">关 闭</el-button>
        <el-button style="float:right" type="primary" @click="submitForm('ruleForm')">确 认</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  data() {
    const validateVcaddr = (rule, value, callback) => {
      const regx = /^[0-9A-Z]{12}$|^[0-9A-Z]{8}$/
      if (value == '') {
    ...
    const validatePn = (rule, value, callback) => {
      if (value == '') {
    ...
    const validateYhbh = (rule, value, callback) => {
      const reg = /^[0-9]+$/
      if (value == '') {
    ...
    const validateGddw = (rule, value, callback) => {
      if (!value) {
    ...
    const validateDevui = (rule, value, callback) => {
      const regx1 = /^[0-9A-Z]{12}$/
      if (value == '') {
  ...
  methods: {
    ...
    derive_tmp() {
      ...
      arr.push('组织架构')
      for (const item in this.Config_tmp) {
    ...
    // 用户编号显示用户名称
    handleUserChange() {
      const Smartmeter = Parse.Object.extend('Smartmeter')
      const smartmeter = new Parse.Query(Smartmeter)
    ...
    page_derive() {
      ...
      // 查询到所有需要的数据
      const start = this.page_start - 1
      const end = this.page_end - 1
      this.yhmxFordepartment4(
    ...
    sure() {
      this.$confirm('此操作将修改此条记录, 是否继续?', '提示', {
        ...
        .then(() => {
          const Yhmx = Parse.Object.extend('Smartmeter')
          const query = new Parse.Query(Yhmx)
