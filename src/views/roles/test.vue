<template>
  <div class="test">
    ...
    <el-dialog :title="$t('developer.add')" :visible.sync="dialogVisible" :before-close="handleClose" :close-on-click-modal="false" width="50%">
    ...
    <!--编辑菜单-->
    <el-dialog :title="$t('developer.edit')" :visible.sync="MenuEdit" :close-on-click-modal="false">
      <el-form :model="MenuForm">
        <el-form-item :label="$t('menu.menuname')" :label-width="formLabelWidth">
          <el-input v-model="MenuForm.name" autocomplete="off" style="width:300px;"/>
        </el-form-item>
        <el-form-item :label="$t('menu.menupath')" :label-width="formLabelWidth">
          <el-input v-model="MenuForm.url" autocomplete="off" style="width:300px;" disabled/>
        </el-form-item>
        ...
        <el-form-item :label="$t('menu.sort')" :label-width="formLabelWidth">
          <el-input v-model="MenuForm.number" autocomplete="off" style="width:300px;" type="number"/>
        </el-form-item>
