<template>
  <div class="standard">
    <div style="padding:20px;" class="devicesright">
      <el-form :inline="true" :model="formInline" class="demo-form-inline" size="small">
        ...
        <el-form-item label="检测名称">
          <el-input v-model="formInline.name" placeholder="请输入检测名称"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    >
      <div class="addContent">
        <el-form ref="reportform" :model="form" :rules="formrule">
          <el-row>
            <el-col :span="12">
              <el-form-item label="检验标准名称" :label-width="formLabelWidth" prop="name">
                <el-input v-model="form.name" autocomplete="off" placeholder="检验标准名称"></el-input>
              </el-form-item>
              <el-form-item label="适用产品" :label-width="formLabelWidth" prop="product">
              ...
              <el-form-item label="标准类型" :label-width="formLabelWidth" prop="model">
            ...
            <el-col :span="12">
              <el-form-item label="检测标准文号" :label-width="formLabelWidth" prop="inspection_number">
                <el-input
              ...
              <el-form-item label="标准类别" :label-width="formLabelWidth" prop="standard">
              ...
              <el-form-item label="标准发行单位" :label-width="formLabelWidth" prop="client">
              ...
              <el-form-item label="标准源文件" :label-width="formLabelWidth" required>
                <el-input placeholder="请输入内容" v-model="form.filesrc" v-loading="loading">
    ...
    <!--标准子项新增弹窗-->
    <el-dialog title="标准子项新增" :visible.sync="dialogReport" width="50%">
      <el-form
    ...
    <!--子项管理弹窗-->
    <el-dialog title="标准子项管理" :visible.sync="dialogTableVisible" width="50%">
      <el-table
      ...
      >
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button type="danger" @click="deleteChildren(scope.$index)" size="small">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
