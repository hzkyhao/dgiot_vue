  ...
  <div class="tasklistmanage">
    ...
    <div class="tasktable">
      ...
      >
        ...
        <el-table-column prop="attr" label="任务属性"/>
        ...
        <el-table-column prop="ts" label="开始执行时间"/>
    ...
    <div class="dialog">
      <el-dialog :visible.sync="dialogFormVisible" :close-on-click-modal="false" title="任务配置" width="40%">
        <el-form ref="form" :model="form" :rules="formrules" label-width="120px">
          ...
          <div
            style="width: 100%;
    margin-left: 50px">
            <el-link :underline="false" icon="el-icon-plus" type="primary" @click="addDomain">添加采集策略</el-link>
          </div>
          ...
          <el-form-item label="上报策略" prop="strategy">
            <el-select v-model="form.strategy" placeholder="上报策略">
              <el-option :value="1" label="逐条上报"/>
              <el-option :value="2" label="统一上报"/>
            </el-select>
          </el-form-item>
