<template>
  <div class="connectlist">
    ...
    <div class="center">
      <div class="centertop">
        <label for="">集中器：</label>
        <el-input v-model="concentrator" placeholder="请输入内容"/>
      ...
      <div class="centertables">
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <div v-if="scope.row.is_online==true" style="width:10px;height:10px;border-radius:50%;display:inline-block;background:#00cc33;margin-right:10px"/><span v-if="scope.row.is_online==true" style="color:#00cc33">在线</span>
              <div v-if="scope.row.is_online==false" style="width:10px;height:10px;border-radius:50%;display:inline-block;background:#f00;margin-right:10px"/><span v-if="scope.row.is_online==false" style="color:#f00">离线</span>
            </template>
          </el-table-column>
        </el-table>
      </div>
