...
export function addSukeyys(name, id, url, para, status_url, status_para, default1) {
  return request({
    url: '/suke/add_yys',
    method: 'post',
    params: {
...
export function editSukeyys(objectId, name, id, url, para, status_url, status_para, default1) {
  return request({
    url: '/suke/edit_yys',
    method: 'put',
    params: {
